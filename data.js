...
const TIMELINE = [
  { year: "1989",
    ...
    body:  { ja: "1989年9月、ベトナムに生まれる。現地の小学校に通いながら、日本語学校にも通い始める。",
             en: "Born in Vietnam in September 1989. Attended local primary school while also starting Japanese-language classes.",
             vi: "Sinh tháng 9 năm 1989 tại Việt Nam. Vừa học tiểu học vừa bắt đầu học tiếng Nhật." } },
  { year: "2003",
    title: { ja: "12歳で来日 ── 熊本県玉名市へ", en: "Arrived in Japan at twelve — Tamana, Kumamoto", vi: "Sang Nhật năm 12 tuổi — Tamana, Kumamoto" },
    body:  { ja: "家族とともに来日し、熊本県玉名市へ。日本語がほとんど分からないまま、中学1年生の2学期から日本の学校に通い始める。",
             en: "Moved to Tamana City, Kumamoto with her family. She entered a Japanese school partway through her first year of junior high, barely able to speak the language.",
             vi: "Cùng gia đình sang Nhật, đến TP. Tamana, Kumamoto. Vào học trường Nhật từ giữa năm lớp 7 khi hầu như chưa biết tiếng." } },
  { year: "2006",
  ...
  { year: "2016",
    ...
    body:  { ja: "1月27日、技能実習生の受入れを担う日越協同組合を設立し代表理事に就任。その3か月後、熊本地震が発生する。",
             en: "On 27 January she established Nichietsu Cooperative, which accepts technical intern trainees, becoming its Representative Director. Three months later the Kumamoto earthquakes struck.",
             vi: "Ngày 27/1 thành lập Nghiệp đoàn Nichietsu tiếp nhận thực tập sinh, giữ chức Chủ tịch. Ba tháng sau xảy ra động đất Kumamoto." } },
  { year: "2017",
  ...
  { year: "2023",
    ...
    body:  { ja: "2022年の副代表理事を経て、9月1日にKUIB代表理事へ。同年、熊本経済同友会にも入会し、地域の経営者コミュニティでの活動を広げる。",
             en: "After serving as Deputy Representative Director from 2022, she took the top role on 1 September, and joined the Kumamoto Association of Corporate Executives the same year.",
             vi: "Sau khi làm Phó chủ tịch từ 2022, ngày 1/9 trở thành Chủ tịch KUIB và gia nhập Hiệp hội doanh nhân Kumamoto." } },
  { year: "2024",
